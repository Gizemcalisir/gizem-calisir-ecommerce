...
export default function FeaturedProducts() {
  return (
    <div className="flex flex-col items-center text-center mt-20 sm:mb-60">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-center sm:gap-y-40 sm:gap-x-8 mt-10 sm:flex-wrap sm:w-[1200px]">
        <ProductBox
